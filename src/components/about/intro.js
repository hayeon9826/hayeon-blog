  ...
  return (
    <>
      <section className="about-intro mb-32">
        ...
        <p className="fs-6">
          3년차 프론트엔드 개발자 김하연 입니다. 새로운 기술의 습득을 중요시하며,{' '}
          ...
          를 통해 개념을 문서화하여 정리하는 것을 좋아합니다. 적극적인 코드리뷰와 동료들과의 기술 토론을 즐기고, 토이
