    ...
    <>
      <section className="about-intro mb-32">
        ...
        <p className="fs-6">
          ...
          활동에서의 2년간의 운영진 활동, 그리고 세 번의 서비스 런칭을 시작으로 개발에 큰 흥미를 느껴 커리어를 쌓게
          되었습니다. 2년간 스타트업 전문 개발사에서 약 10여개의 스타트업 MVP 출시하며 고객사와의 효율적인 협업의
          중요성과 우선순위에 맞춰 기간내 빠르게 제품을 완성하는 개발을 배웠습니다. 현재는{' '}
