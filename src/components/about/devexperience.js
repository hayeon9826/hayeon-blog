        ...
        <div className="column-list">
          ...
          <div style={{ width: '75%' }} className="column">
            ...
            <p>
              ...
              내에서 대출 상품 및 약정을 비교하고 대출을 받을 수 있게하는 <b>인앱약정 상품</b>을 개발했습니다. 또한,
              기존에 앱으로 구성되어있던 한도조회 리스트/상세/부결/미승인 페이지를 웹뷰로 리뉴얼 & 이전하는{' '}
              <b>대출 의사결정 개선</b> 프로젝트를 주도하여 개발했습니다.
            </p>
            <h5>Tech Stack.</h5>
            ...
            <ul className="bulleted-list">
              ...
              <li>
                앱으로 구성되어있던 한도조회 리스트/상세/부결/미승인 페이지를 웹뷰로 리뉴얼 & 이전하는{' '}
                <b>대출 의사결정 개선</b> 프로젝트를 주도하여 개발했습니다. 웹뷰 성능 개선을 위해 lighthouse로 웹뷰
                페이지를 분석하였고, 속도 및 성능을 개선하는 작업을 진행했습니다.
              </li>
            </ul>
          ...
          <div style={{ width: '75%' }} className="column">
            ...
            <ul className="bulleted-list">
              <li>
                ...
                <a href="https://hayeondev.com/221030-nextjs-ie-redirects/" target="_blank">
                  [참고 링크]
                </a>
              </li>
            </ul>
          ...
          <div style={{ width: '75%' }} className="column">
            ...
            <ul className="bulleted-list">
              <li>
                ...
                작성해 공유하였습니다.{' '}
                <a href="https://hayeondev.com/220125-firestore-react-chat-app/" target="_blank">
                  [참고 링크]
                </a>
              </li>
            </ul>
            <ul className="bulleted-list">
              <li>
                ...
                <a href="https://hayeondev.com/220209-react-calendar/" target="_blank">
                  [참고 링크]
                </a>
              </li>
            </ul>
          ...
          <div style={{ width: '75%' }} className="column">
            ...
            <ul className="bulleted-list">
              <li>
                ...
                <a href="https://hayeondev.com/211209-react-csv/" target="_blank">
                  [참고 링크]
                </a>
              </li>
              <li>
            ...
            <ul className="bulleted-list">
              ...
              <li>
                ...
                <a href="https://hayeondev.com/211011-webpack-bundle-analyzer/" target="_blank">
                  [참고 링크]
                </a>
              </li>
            </ul>
