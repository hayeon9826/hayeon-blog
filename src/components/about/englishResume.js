        ...
        <div className="container">
          ...
          <article>
            ...
            <div className="pb-15px">
              ...
              user interfaces, meticulous testing and debugging. Value acquiring new technologies and organizing
          ...
          <article>
            ...
            <div className="row exp-list">
              <ul>
                ...
                <li>
                  ...
                  via Finda App. Also, built desgin system and deployed to Storybook (chromatic) by cooperating with the
                  designers.
                </li>
                <li>
                ...
                <li>
                  Contributed on building design system and organized common componentes on Storybook. Reduced
                  communication requests on Jira (Confluence Cooperation Tool) by 20%.
                </li>
                <li>
                  Updated legacy code base (class function) to new functional components. Implemented Next.js SSG(Static
            ...
            <div className="row exp-list">
              <ul>
                ...
                <li>
                  Participated in developing code builder template by building 'Likes, Item lists, Post list, Login &
                  Registration, Cart' features. Approximately saved 80 hours of each developer's inital setup working
                  hours.
                </li>
                <li>
                  Transferred MVP startup service to AWS service considering better security and scalability. Applied
                  AWS Cognito on user registrations and deployed via AWS EC2 and S3.
                </li>
                <li>
                  Worked on more than 20 technical documents and shared the entire troubleshooting process with other
            ...
            <div className="row exp-list">
              <ul>
                ...
                <li>
                  Conducted Web Publishing referring to the design figma from desginer. Applied CSS with custom class
                  names in BEM model.
                </li>
          ...
          <article>
            ...
            <div className="row">
              <ul>
                ...
                <li>
                  {' '}
                  Bachelor of <b>Creative Technology Management(CTM)</b>, Yonsei University Underwood International
                  College
                </li>
